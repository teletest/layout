            ...
            <table border="0" width="94%" cellspacing="1">
									...
									<tr>
									  ...
									  <td width="30">
									    ...
									    <img border="0" src="{site_url}theme/images/log_out.png" width="25" height="25" id="img19" onmouseout="this.src='{site_url}theme/images/log_out.png'" onmouseover="this.src='{site_url}theme/images/log_outover.png'"></a></td>
			</tr>
									<tr>
